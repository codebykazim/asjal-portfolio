      ...
      <div className="grid grid-cols-12 gap-4 xs:gap-6 md:gap-8 w-full max-w-screen-2xl">
        ...
        >
          ...
          <p className="font-light text-gray-300 text-xs xs:text-sm 2xl:text-lg tracking-wide mb-4">
            Hello! I&#39;m Asjal, a skilled Cloud Data Engineer and Frontend
        ...
        >
          <p className="font-semibold w-full text-center text-3xl md:text-7xl">
            18+ <sub className="font-semibold text-xl text-gray-300">Projects</sub>
          </p>
        </AnimateLayout>
        ...
        <AnimateLayout className={"col-span-full bg-gray-800 border border-gray-600 rounded-xl p-6"}>
          <div className="flex flex-wrap items-center justify-center gap-4">
            ...
            <div className="bg-gray-700 p-2 md:p-3 rounded-2xl border border-gray-600 hover:border-cyan-400 transition-all duration-300">
              <RiNextjsFill className="w-8 h-8 xs:w-10 xs:h-10 sm:w-10 sm:h-10 md:w-12 md:h-12 lg:w-14 lg:h-14 xl:w-16 xl:h-16 text-white" />
            </div>
            <div className="bg-gray-700 text-sky-500 p-2 md:p-3 rounded-2xl border border-gray-600 hover:border-cyan-400 transition-all duration-300">
              <GrReactjs className="w-8 h-8 xs:w-10 xs:h-10 sm:w-10 sm:h-10 md:w-12 md:h-12 lg:w-14 lg:h-14 xl:w-16 xl:h-16" />
            </div>
            <div className="bg-gray-700 text-sky-600 p-2 md:p-3 rounded-2xl border border-gray-600 hover:border-cyan-400 transition-all duration-300">
            ...
            <div className="bg-gray-700 text-orange-500 p-2 md:p-3 rounded-2xl border border-gray-600 hover:border-cyan-400 transition-all duration-300">
            ...
            <div className="bg-gray-700 p-2 md:p-3 rounded-2xl border border-gray-600 hover:border-cyan-400 transition-all duration-300">
              <SiVercel className="w-8 h-8 xs:w-10 xs:h-10 sm:w-10 sm:h-10 md:w-12 md:h-12 lg:w-14 lg:h-14 xl:w-16 xl:h-16 text-white" />
            </div>
            <div className="bg-gray-700 text-sky-500 p-2 md:p-3 rounded-2xl border border-gray-600 hover:border-cyan-400 transition-all duration-300">
              <VscVscodeInsiders className="w-8 h-8 xs:w-10 xs:h-10 sm:w-10 sm:h-10 md:w-12 md:h-12 lg:w-14 lg:h-14 xl:w-16 xl:h-16" />
            </div>
            <div className="bg-gray-700 text-purple-300 p-2 md:p-3 rounded-2xl border border-gray-600 hover:border-cyan-400 transition-all duration-300">
